<script lang="ts">
	...
	function importSnippet(icon: string): string {
		return `<script lang="ts">\n\timport { ${icon} } from 'svelte-animated-icon/flowbite';\n</` + `script>`;
	}

	function usageSnippet(icon: string): string {
		const v = variant === 'outline' ? '' : ` variant="${variant}"`;
...
<svelte:head>
	<title>Flowbite Icons · Svelte Animated Icon</title>
	<meta name="description" content="Explore and customize Flowbite animated icons for Svelte 5. Select variants, adjust speed, easing, and copy production-ready code snippets." />
	
	<!-- Open Graph / Facebook -->
	<meta property="og:type" content="website" />
	<meta property="og:url" content="https://svelte-animated-icon.vercel.app/flowbite" />
	<meta property="og:title" content="Flowbite Icons · Svelte Animated Icon" />
	<meta property="og:description" content="Explore and customize Flowbite animated icons for Svelte 5. Select variants, adjust speed, easing, and copy production-ready code snippets." />
	<meta property="og:image" content="https://svelte-animated-icon.vercel.app/images/svelte-animated-icon.webp" />

	<!-- Twitter -->
	<meta property="twitter:card" content="summary_large_image" />
	<meta property="twitter:url" content="https://svelte-animated-icon.vercel.app/flowbite" />
	<meta property="twitter:title" content="Flowbite Icons · Svelte Animated Icon" />
	<meta property="twitter:description" content="Explore and customize Flowbite animated icons for Svelte 5. Select variants, adjust speed, easing, and copy production-ready code snippets." />
	<meta property="twitter:image" content="https://svelte-animated-icon.vercel.app/images/svelte-animated-icon.webp" />
</svelte:head>

<div class="page-header">
	<h1 class="ls-tightx">Flowbite Icons</h1>
	<p class="col2 text-md">
		{allIcons.length} icons · outline and solid variants · hover to animate.
	</p>
</div>
